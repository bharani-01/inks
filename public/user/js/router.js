/**
 * Printa — User Router
 * Auth guard + sidebar init for user zone
 */
(function () {
  ...
  // Guard: if admin, redirect to admin area
...
function initUserHeaderDropdown() {
  ...
  // Insert user dropdown menu into top right header
  ...
  wrapper.innerHTML = `
    <button type="button" class="user-menu-trigger" id="header-user-trigger">
      ...
      <div class="user-menu-details">
        ...
        <span class="user-menu-role">Customer</span>
      </div>
    ...
    <div class="user-menu-dropdown" id="header-user-dropdown">
      <a href="/user/print" class="dropdown-item">
        <span class="nav-icon" data-icon="printer"></span> <span>Print Now</span>
      </a>
      <a href="/user/orders" class="dropdown-item">
        <span class="nav-icon" data-icon="package"></span> <span>My Orders</span>
      </a>
      <a href="/user/profile" class="dropdown-item">
        <span class="nav-icon" data-icon="settings"></span> <span>Settings</span>
      </a>
      <div class="dropdown-divider"></div>
      <button type="button" class="dropdown-item danger" onclick="localStorage.removeItem('printa_token'); localStorage.removeItem('printa_user'); window.location.href='/login';">
        <span class="nav-icon" data-icon="logOut"></span> <span>Log Out</span>
      </button>
    </div>
  `;

  // Render SVG icons inside dropdown
